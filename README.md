...
function stuurBevestigingsmail($email, $naam, $kamer, $check_in, $check_uit, $prijs)
{
...
        $mail->setFrom('hbakulakun6969@gmail.com', 'Hotel De Zonne Vallei');
...
        return true;
    } catch (Exception $e) {
        // Toon de exacte PHPMailer foutmelding direct op de pagina:
